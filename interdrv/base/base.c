...
#define CV180X_RTC_BASE 0x03005000
#define CV181X_RTC_BASE 0x05026000
...
static int __init base_init(void)
{
	...
	if (IS_CHIP_CV181X(chip_id))
		rtc_base = ioremap(CV181X_RTC_BASE, RTC_REG_BANK_SIZE);
	else
		rtc_base = ioremap(CV180X_RTC_BASE, RTC_REG_BANK_SIZE);
